...
Considering the base cases first : 
1. n==1 -> then the answer would be 1
2. n==2 or n==3 -> then we cannot find any permutations. (1,2),(2,1),(1,2,3),(2,1,3),(3,1,2),(3,2,1)  ... (2,3,1)   are all invalid.<br/>

Now we can think of printing odd numbers then even numbers or vice versa but we should start with parity which has more numbers.<br/>
So for even n we can start with any but for odd n we need to start with odd numbers first then even numbers.
