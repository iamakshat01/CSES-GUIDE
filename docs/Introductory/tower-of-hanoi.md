...
<img src="https://miro.medium.com/max/859/1*eR2gxp8mKeaEWbbj4-cLMQ.png" alt="drawing" width="300"/>
...
void tower(ll n,char from_rod,char to_rod, char aux_rod) 
{ 
    if(n==1) 
    { 
