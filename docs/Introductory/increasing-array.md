...
We need to make every number as large as previous. So, we start a loop from 2nd element of array.

1. If current is smaller than prev. Opertions required would be prev-cur and cur would become equal to prev.
2. Else continue
