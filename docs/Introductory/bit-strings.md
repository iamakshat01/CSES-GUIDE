...
So we need to find all possible binary strings of length n. At each position there are two possibilities either 1 or 0. So total possible strings are 2<sup>n</sup>.

We need to do modular exponentiation here.
