...
Sum of n natural numbers is n(n+1)/2. We subtract n-1 natural numbers given to us from the sum i.e. n(n+1)/2 and the missing number would be remaining total.
