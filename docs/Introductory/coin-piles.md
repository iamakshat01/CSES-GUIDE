...
We need to empty both the piles. If we take first move and then second move , we are able to remove 3 coins from both piles equally. 

So we remove some 3k coins from both piles such that min(a,b)>=3k. So answer would be Yes only if ->
1. a and b both equal to 0
2. a is 1 and b is 2
3. a is 2 and b is 1

In 2 and 3 we would take a move accordingly and piles ould be empty.
