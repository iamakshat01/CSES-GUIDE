...
We maintain a counter c. If character at index i and index i-1 are same, We increase the counter by 1 as there is repetition otherwise repetition is broken and We set counter to be 1. At each index we take the maximum of counter as our answer.
